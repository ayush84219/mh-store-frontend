...
export default function MaterialDetailsView({
  ...
  return (
    <div className="animate-fade">
      ...
      {/* =========================================================================
          Dedicated Clean Printable Raw Materials Inventory Report (Print Mode Only)
          ========================================================================= */}
      <div className="materials-inventory-print-layout" style={{
        ...
        <div style={{
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <h1 style={{ margin: 0, fontSize: '20px', fontWeight: '900', letterSpacing: '0.04em', textTransform: 'uppercase', color: '#000000' }}>
                MH STORE
              </h1>
              <span style={{ fontSize: '11px', fontWeight: '800', padding: '2px 8px', border: '1.5px solid #000000', borderRadius: '4px', textTransform: 'uppercase' }}>
                Inventory System
              </span>
            </div>
            <p style={{ margin: '4px 0 0 0', fontSize: '13px', fontWeight: '800', color: '#111111' }}>
              RAW MATERIALS STOCK DATABASE & INVENTORY AUDIT REPORT
            </p>
            <p style={{ margin: '2px 0 0 0', fontSize: '10.5px', color: '#555555' }}>
              Textile fabrics, buttons, zippers, trims, and stock distribution across warehouse locations.
            </p>
          </div>

          <div style={{ textAlign: 'right', fontSize: '10.5px', lineHeight: '1.5', color: '#000000' }}>
            <div><strong>Date:</strong> {new Date().toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })}</div>
            <div><strong>Time:</strong> {new Date().toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit', hour12: true })}</div>
            <div><strong>Generated By:</strong> {currentUser?.name || 'Ayush'} ({currentUser?.role || 'Designer'})</div>
            <div><strong>Category Filter:</strong> {selectedCategory === 'all' ? 'All Categories' : selectedCategory}</div>
            <div><strong>Status Filter:</strong> {statusFilter === 'all' ? 'All Status' : statusFilter === 'in_stock' ? 'In Stock' : statusFilter === 'low_stock' ? 'Low Stock' : 'Zero Stock'}</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ border: '1.5px solid #000000', borderRadius: '4px', padding: '6px 10px', textAlign: 'center', background: '#f8fafc' }}>
            <div style={{ fontSize: '9.5px', fontWeight: '800', textTransform: 'uppercase', color: '#475569' }}>Total Materials</div>
            <div style={{ fontSize: '16px', fontWeight: '900', color: '#000000', marginTop: '2px' }}>{metrics.total} Items</div>
          </div>
          <div style={{ border: '1.5px solid #000000', borderRadius: '4px', padding: '6px 10px', textAlign: 'center', background: '#f0fdf4' }}>
            <div style={{ fontSize: '9.5px', fontWeight: '800', textTransform: 'uppercase', color: '#166534' }}>In-Stock Optimal</div>
            <div style={{ fontSize: '16px', fontWeight: '900', color: '#166534', marginTop: '2px' }}>{metrics.inStock} Items</div>
          </div>
          <div style={{ border: '1.5px solid #000000', borderRadius: '4px', padding: '6px 10px', textAlign: 'center', background: '#fffbeb' }}>
            <div style={{ fontSize: '9.5px', fontWeight: '800', textTransform: 'uppercase', color: '#92400e' }}>Low Stock Alert</div>
            <div style={{ fontSize: '16px', fontWeight: '900', color: '#92400e', marginTop: '2px' }}>{metrics.lowStock} Items</div>
          </div>
          <div style={{ border: '1.5px solid #000000', borderRadius: '4px', padding: '6px 10px', textAlign: 'center', background: '#fef2f2' }}>
            <div style={{ fontSize: '9.5px', fontWeight: '800', textTransform: 'uppercase', color: '#991b1b' }}>Zero Stock / Pending</div>
            <div style={{ fontSize: '16px', fontWeight: '900', color: '#991b1b', marginTop: '2px' }}>{metrics.zeroStock} Items</div>
          </div>
        </div>

        {/* Filter / Record Count Strip */}
        <div style={{
          display: 'flex',
          justifyContent: 'space-between',
          alignItems: 'center',
          ...
          <span>Showing <strong>{filteredMaterials.length}</strong> of <strong>{materials.length}</strong> total material records</span>
          {debouncedSearchQuery && <span>Search Filter: "{debouncedSearchQuery}"</span>}
        </div>
        ...
        <table style={{
          ...
          <thead>
            <tr style={{ backgroundColor: '#e2e8f0', borderBottom: '1.5px solid #000000' }}>
              <th style={{ border: '1px solid #000000', padding: '6px 4px', textAlign: 'center', width: '28px', fontWeight: '800' }}>#</th>
              <th style={{ border: '1px solid #000000', padding: '6px 6px', textAlign: 'left', width: '75px', fontWeight: '800' }}>ITEM ID</th>
              <th style={{ border: '1px solid #000000', padding: '6px 8px', textAlign: 'left', fontWeight: '800' }}>MATERIAL NAME & DESCRIPTION</th>
              <th style={{ border: '1px solid #000000', padding: '6px 6px', textAlign: 'center', width: '85px', fontWeight: '800' }}>CATEGORY</th>
              <th style={{ border: '1px solid #000000', padding: '6px 6px', textAlign: 'left', width: '95px', fontWeight: '800' }}>COLOR / SHADE</th>
              <th style={{ border: '1px solid #000000', padding: '6px 6px', textAlign: 'left', width: '105px', fontWeight: '800' }}>STORAGE LOCATION</th>
              <th style={{ border: '1px solid #000000', padding: '6px 6px', textAlign: 'left', width: '95px', fontWeight: '800' }}>PO & BILL REF</th>
              <th style={{ border: '1px solid #000000', padding: '6px 6px', textAlign: 'right', width: '90px', fontWeight: '800' }}>STOCK QTY</th>
              <th style={{ border: '1px solid #000000', padding: '6px 6px', textAlign: 'center', width: '80px', fontWeight: '800' }}>STATUS</th>
            </tr>
          </thead>
          <tbody>
            {filteredMaterials.length === 0 ? (
              <tr>
                <td colSpan="9" style={{ border: '1px solid #000000', textAlign: 'center', padding: '20px', fontStyle: 'italic' }}>
                  No materials match the current filter selection.
                </td>
              </tr>
            ) : (
              filteredMaterials.map((m, idx) => {
                ...
                return (
                  <tr key={m.id || idx} style={{ pageBreakInside: 'avoid', borderBottom: '1px solid #000000' }}>
                    <td style={{ border: '1px solid #000000', padding: '5px 4px', textAlign: 'center', fontWeight: '700' }}>
                      {idx + 1}
                    </td>
                    <td style={{ border: '1px solid #000000', padding: '5px 6px', fontFamily: 'monospace', fontWeight: '800', fontSize: '10.5px' }}>
                      {m.id}
                    </td>
                    <td style={{ border: '1px solid #000000', padding: '5px 8px' }}>
                      <div style={{ fontWeight: '700', fontSize: '10.5px' }}>{m.name}</div>
                      <div style={{ fontSize: '9px', color: '#555555' }}>
                        Threshold: {m.threshold} {m.unit || 'pcs'}
                      </div>
                    </td>
                    <td style={{ border: '1px solid #000000', padding: '5px 6px', textAlign: 'center', fontWeight: '600' }}>
                      {m.category || 'Accessory'}
                    </td>
                    ...
                    <td style={{ border: '1px solid #000000', padding: '5px 6px', textAlign: 'right', fontWeight: '800', fontSize: '11px' }}>
                      {numStock.toLocaleString()} <span style={{ fontSize: '9.5px', fontWeight: '600' }}>{m.unit || 'pcs'}</span>
                    </td>
                    <td style={{ border: '1px solid #000000', padding: '5px 6px', textAlign: 'center' }}>
                      <span style={{
                        ...
                        fontSize: '9px',
                        fontWeight: '800',
                        border: isZero ? '1.5px solid #dc2626' : isLow ? '1.5px solid #d97706' : '1.5px solid #16a34a',
                        color: isZero ? '#dc2626' : isLow ? '#d97706' : '#16a34a'
                      }}>
        ...
        <div style={{
          ...
          <div style={{ borderTop: '1.5px solid #000000', paddingTop: '6px', textAlign: 'center' }}>
            <div style={{ fontWeight: '800', fontSize: '10.5px' }}>Prepared By</div>
            <div style={{ fontSize: '9.5px', color: '#555555', marginTop: '1px' }}>Store Keeper / Operator</div>
          </div>
          <div style={{ borderTop: '1.5px solid #000000', paddingTop: '6px', textAlign: 'center' }}>
            <div style={{ fontWeight: '800', fontSize: '10.5px' }}>Verified By</div>
            <div style={{ fontSize: '9.5px', color: '#555555', marginTop: '1px' }}>Inventory In-Charge / QC</div>
          </div>
          <div style={{ borderTop: '1.5px solid #000000', paddingTop: '6px', textAlign: 'center' }}>
            <div style={{ fontWeight: '800', fontSize: '10.5px' }}>Authorized Signature</div>
            <div style={{ fontSize: '9.5px', color: '#555555', marginTop: '1px' }}>Plant Manager / Admin</div>
          </div>
        </div>

        {/* System Watermark & Security Footer */}
        <div style={{
          marginTop: '18px',
          paddingTop: '6px',
          ...
          <span>MH STORE • Material Requirements & Inventory Management System</span>
